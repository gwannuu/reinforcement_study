...
\usepackage{algorithm2e} % use algorithm
...
Algorithm \ref{alg:alg5} improves policy as $\epsilon$-greedy.
\begin{algorithm} 
...
In algorithm \ref{alg:alg5}, policy improvement and policy evaluation occur alternately, one after the other. 
